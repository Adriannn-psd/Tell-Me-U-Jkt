            ...
            <div className="mb-8 max-w-2xl mx-auto">
                ...
                <div className="text-white text-sm mt-1">
                  <div className="flex items-center gap-1.5 mt-1">
                    ...
                    {profileData?.instagram ? (
                      ...
                      <a href="https://lynk.id/tellmeujkt" target="_blank" rel="noreferrer" className="hover:underline text-[var(--color-text-2)] hover:text-white transition">
                        lynk.id/tellmeujkt
                      </a>
                    )}
                  </div>
              ...
              {!isLoadingSession && !isOwnProfile && (
                <div className="flex items-center gap-2 px-2">
                  ...
                  <button className="flex-1 bg-[var(--color-surface)] border border-[var(--color-surface-2)] hover:bg-[var(--color-surface-2)] transition text-white text-sm font-semibold py-1.5 rounded-lg">
                    Kirim Pesan
                  </button>
                  <button className="bg-[var(--color-surface)] border border-[var(--color-surface-2)] hover:bg-[var(--color-surface-2)] transition p-1.5 rounded-lg">
